...
const buttonVariants = cva(
  "flex overflow-hidden font-medium gap-2 select-none rounded-lg active:scale-90 cursor-pointer items-center justify-center text-sm focus:ring-2 shadow disabled:opacity-70 disabled:cursor-not-allowed disabled:active:scale-100 transition-all",
  {
    variants: {
      variant: {
        primary:
